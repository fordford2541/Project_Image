...
for i in range(1,20):
  ...
  img = cv2.imread('test photo/1080p/IMG_1 ('+str(i)+').jpg',cv2.IMREAD_COLOR)
  ...
  imgresize = cv2.resize(img_show,(480,270))
  cv2.imwrite('test photo/1080p/GUI/IMG_'+str(i)+'.jpg', imgresize)
